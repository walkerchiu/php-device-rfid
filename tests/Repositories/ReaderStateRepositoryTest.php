...
class ReaderStateRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testcreateLangWithoutCheck()
    {
        ...
        // Give
        $db_reader = factory(Reader::class)->create();
        factory(ReaderState::class)->create(['reader_id' => $db_reader->id]);
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        $db_reader = factory(Reader::class)->create();
        $db_morph_1 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id, 'is_enabled' => 1]);
        $db_morph_2 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id]);
        $db_morph_3 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id]);
        $db_morph_4 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id]);
    ...
    public function testQueryList()
    {
        ...
        // Give
        $db_reader = factory(Reader::class)->create();
        $db_morph_1 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id]);
        $db_morph_2 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id]);
        $db_morph_3 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id]);
        $db_morph_4 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id]);
    ...
    public function testFormTrait()
    {
        ...
        // Name
            ...
            $db_morph_1 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id]);
            $db_morph_2 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id]);
            $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
            $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => ReaderState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
            // When
        ...
        // Serial, Identifier
            // Give
            $db_morph_3 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id, 'serial' => '123', 'identifier' => 'A123']);
            $db_morph_4 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id, 'serial' => '124', 'identifier' => 'A124']);
            $db_morph_5 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id, 'serial' => '125', 'identifier' => 'A125', 'is_enabled' => 0]);
    ...
    public function testAutoComplete()
    {
        ...
        // Give
        $db_reader = factory(Reader::class)->create();
        $db_morph_1 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id, 'serial' => 'A123', 'is_enabled' => 1]);
        $db_morph_2 = factory(ReaderState::class)->create(['reader_id' => $db_reader->id, 'serial' => 'A124', 'is_enabled' => 1]);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'description', 'value' => 'Good Morning!']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello World']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => ReaderState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '您好']);
        $db_lang_1 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_1->id, 'morph_type' => ReaderState::class, 'code' => 'zh_tw', 'key' => 'name', 'value' => '早安']);
        $db_lang_2 = $this->repository->createLangWithoutCheck(['morph_id' => $db_morph_2->id, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Bye']);
