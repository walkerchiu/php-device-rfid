...
class ReaderRegisterRepositoryTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testEnableAndDisable()
    {
        ...
        // Give
        $db_reader = factory(Reader::class)->create();
        $db_morph_1 = factory(ReaderRegister::class)->create(['reader_id' => $db_reader->id, 'is_enabled' => 1]);
        $db_morph_2 = factory(ReaderRegister::class)->create(['reader_id' => $db_reader->id]);
        $db_morph_3 = factory(ReaderRegister::class)->create(['reader_id' => $db_reader->id]);
        $db_morph_4 = factory(ReaderRegister::class)->create(['reader_id' => $db_reader->id]);
