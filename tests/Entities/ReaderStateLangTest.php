...
class ReaderStateLangTest extends \Orchestra\Testbench\TestCase
{
    ...
    public function testReaderStateLang()
    {
        ...
        $db_lang_1 = factory(ReaderStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'name', 'value' => 'Hello']);
        $db_lang_2 = factory(ReaderStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'description']);
        $db_lang_3 = factory(ReaderStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => ReaderState::class, 'code' => 'zh_tw', 'key' => 'description']);
        $db_lang_4 = factory(ReaderStateLang::class)->create(['morph_id' => $db_morph_1->id, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_5 = factory(ReaderStateLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => ReaderState::class, 'code' => 'en_us', 'key' => 'name']);
        $db_lang_6 = factory(ReaderStateLang::class)->create(['morph_id' => $db_morph_2->id, 'morph_type' => ReaderState::class, 'code' => 'zh_tw', 'key' => 'description']);
        ...
        // Get record's morph
            // When
            $record = ReaderStateLang::find($db_lang_1->id);
            // Then
    ...
    public function testReaderState()
    {
        ...
        // Get lang of record
            // When
            $record_1 = ReaderState::find($db_morph_1->id);
            $lang_1   = ReaderStateLang::find($db_lang_1->id);
            $lang_4   = ReaderStateLang::find($db_lang_4->id);
            // Then
        ...
        // Get lang's histories of record
            ...
            $record_2 = ReaderState::find($db_morph_2->id);
